...
Initial Setup
   ...
   Install obspy
        ...
        conda install conda-forge::smbus2
        conda install pyserial
        

        
Connecting the sensor
   Shut down and unplug the Raspberry Pi before connecting
    
   Using dupont female to male jumper wires (or alternate wire solution if desired), connect the sensor pins to the Raspberry Pi as follows:
...
Sensor testing:
    ...
    wget https://github.com/dedxi/Infrasound-Monitor-3DP/raw/refs/heads/master/Software/infrasound-python-downloads.zip
    unzip infrasound-python-downloads.zip
    cd TestRoutines
    nano quickRead.py
    
   [update /home/pi/InfraSound to a valid file path]

    python3 quickRead.py
